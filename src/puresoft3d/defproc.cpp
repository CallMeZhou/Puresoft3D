...
void* _stdcall VertexProcesserDEF01::createInstance(void)
{
	return new VertexProcesserDEF01;
}
...
void VertexProcesserDEF01::release(void)
{
	delete this;
}

void VertexProcesserDEF01::process(const VertexProcessorInput* input, VertexProcessorOutput* output, const void** uniforms)
{
...
void* _stdcall InterpolationProcessorDEF01::createInstance(void)
{
	return new InterpolationProcessorDEF01;
}
...
void InterpolationProcessorDEF01::release()
{
	delete this;
}

void InterpolationProcessorDEF01::interpolateByContributes(void* interpolatedUserData, const void** vertexUserData, const float* correctedContributes)
{
...
void InterpolationProcessorDEF01::calcStep(void* interpolatedUserDataStep, const void* interpolatedUserDataStart, const void* interpolatedUserDataEnd, int stepCount)
{
...
void InterpolationProcessorDEF01::interpolateBySteps(void* interpolatedUserData, void* interpolatedUserDataStart, const void* interpolatedUserDataStep, float correctionFactor2)
{
	PROCDATA_DEF01* output = (PROCDATA_DEF01*)interpolatedUserData;
	PROCDATA_DEF01* start = (PROCDATA_DEF01*)interpolatedUserDataStart;
...
void* _stdcall FragmentProcessorDEF01::createInstance(void)
{
	return new FragmentProcessorDEF01;
}
...
void FragmentProcessorDEF01::release()
{
	delete this;
}

void FragmentProcessorDEF01::process(const FragmentProcessorInput* input, FragmentProcessorOutput* output, const void** uniforms, const void** textures)
{
